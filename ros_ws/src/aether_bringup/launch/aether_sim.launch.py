...
def generate_launch_description():
    ...
    sdf_path = os.path.join(pkg_project_description, "models", "aether", "model.sdf")
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={
            "gz_args": PathJoinSubstitution(
                [pkg_project_gazebo, "worlds", "simple_maze.sdf"]
            )
        }.items(),
    )
    ...
    spawn = Node(
        package="ros_gz_sim",
        executable="create",
        parameters=[{"name": "aether", "string": robot_desc}],
        output="screen",
    )
